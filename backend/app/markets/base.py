"""Shared market strategy interfaces for PaiiD-2mx."""
...
class MarketContext:
    """Runtime context describing a market module invocation."""
...
class MarketBootstrapResult:
    """Container for service wiring generated by a market strategy."""
